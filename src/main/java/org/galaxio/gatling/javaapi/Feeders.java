...
import static org.galaxio.gatling.javaapi.internal.Feeders.*;
...
public final class Feeders {
    ...
    public static Iterator<Map<String, Object>> CurrentDateFeeder(String paramName, DateTimeFormatter datePattern, ZoneId timezone) {
        return toJavaFeeder(org.galaxio.gatling.feeders.CurrentDateFeeder.apply(paramName, datePattern, timezone));
    }
    ...
    public static <T> Iterator<Map<String, Object>> CustomFeeder(String paramName, Function0<T> f) {
        return toJavaFeeder(
                org.galaxio.gatling.feeders.CustomFeeder.apply(paramName, f)
        );
    }
    ...
    public static Iterator<Map<String, Object>> RandomDateFeeder(
        ...
        return toJavaFeeder(
                org.galaxio.gatling.feeders.RandomDateFeeder.apply(
                        paramName,
                        positiveDaysDelta,
                        negativeDaysDelta,
                        datePattern,
    ...
    public static Iterator<Map<String, Object>> RandomDateRangeFeeder(
        ...
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomDateRangeFeeder.apply(paramNameFrom, paramNameTo, offsetDate, datePattern, dateFrom, unit, timezone));
    }
    ...
    public static Iterator<Map<String, Object>> RandomDigitFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomDigitFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomJurITNFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomJurITNFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomKPPFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomKPPFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomNatITNFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomNatITNFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomOGRNFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomOGRNFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomPANFeeder(String paramName, String... bins) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomPANFeeder.apply(paramName, asScala(Arrays.asList(bins)).toSeq()));
    }

    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomPhoneFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, PhoneFormat... formats) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomPhoneFeeder.apply(paramName, asScala(Arrays.asList(formats)).toSeq()));
    }
    ...
    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, TypePhone.TypePhone typePhone, PhoneFormat... formats) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomPhoneFeeder.apply(paramName, typePhone, asScala(Arrays.asList(formats)).toSeq()));
    }
    ...
    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, String formatsPath, TypePhone.TypePhone typePhone) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomPhoneFeeder.apply(paramName, formatsPath, typePhone));
    }

    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, String formatsPath) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomPhoneFeeder.apply(paramName, formatsPath));
    }

    public static Iterator<Map<String, Object>> RandomPSRNSPFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomPSRNSPFeeder.apply(paramName));
    }
    ...
    public static Iterator<Map<String, Object>> RandomRangeStringFeeder(String paramName, Integer from, Integer to, String alphabet) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomRangeStringFeeder.apply(paramName, from, to, alphabet));
    }
    ...
    public static Iterator<Map<String, Object>> RandomRusPassportFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomRusPassportFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomSNILSFeeder(String paramName) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomSNILSFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomStringFeeder(String paramName, Integer paramLength) {
        return toJavaFeeder(org.galaxio.gatling.feeders.RandomStringFeeder.apply(paramName, paramLength));
    }
    ...
    public static final class SeparatedValuesFeeder {
        ...
        public static Iterator<Map<String, Object>> apply(String paramName, String source, char separator) {
            return toJavaFeeder(org.galaxio.gatling.feeders.SeparatedValuesFeeder.apply(paramName, source, separator));
        }
    ...
    public static Iterator<Map<String, Object>> SequentialFeeder(String paramName, Integer start, Integer step) {
        return toJavaFeeder(org.galaxio.gatling.feeders.SequentialFeeder.apply(paramName, start, step));
    }
