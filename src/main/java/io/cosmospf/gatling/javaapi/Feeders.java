...
import io.cosmospf.gatling.utils.phone.PhoneFormat;
import io.cosmospf.gatling.utils.phone.TypePhone;
import scala.Function0;
import scala.Option;

import static io.cosmospf.gatling.javaapi.internal.Feeders.*;
...
public final class Feeders {
    ...
    public static Iterator<Map<String, Object>> CurrentDateFeeder(String paramName, DateTimeFormatter datePattern, ZoneId timezone) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.CurrentDateFeeder.apply(paramName, datePattern, timezone));
    }
    ...
    public static <T> Iterator<Map<String, Object>> CustomFeeder(String paramName, Function0<T> f) {
        return toJavaFeeder(
                io.cosmospf.gatling.feeders.CustomFeeder.apply(paramName, f)
        );
    }
    ...
    public static Iterator<Map<String, Object>> RandomDateFeeder(
        ...
        return toJavaFeeder(
                io.cosmospf.gatling.feeders.RandomDateFeeder.apply(
                        paramName,
                        positiveDaysDelta,
                        negativeDaysDelta,
                        datePattern,
    ...
    public static Iterator<Map<String, Object>> RandomDateRangeFeeder(
        ...
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomDateRangeFeeder.apply(paramNameFrom, paramNameTo, offsetDate, datePattern, dateFrom, unit, timezone));
    }
    ...
    public static Iterator<Map<String, Object>> RandomDigitFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomDigitFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomJurITNFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomJurITNFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomKPPFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomKPPFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomNatITNFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomNatITNFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomOGRNFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomOGRNFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomPANFeeder(String paramName, String... bins) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomPANFeeder.apply(paramName, asScala(Arrays.asList(bins)).toSeq()));
    }

    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomPhoneFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, PhoneFormat... formats) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomPhoneFeeder.apply(paramName, asScala(Arrays.asList(formats)).toSeq()));
    }
    ...
    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, TypePhone.TypePhone typePhone, PhoneFormat... formats) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomPhoneFeeder.apply(paramName, typePhone, asScala(Arrays.asList(formats)).toSeq()));
    }
    ...
    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, String formatsPath, TypePhone.TypePhone typePhone) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomPhoneFeeder.apply(paramName, formatsPath, typePhone));
    }

    public static Iterator<Map<String, Object>> RandomPhoneFeeder(String paramName, String formatsPath) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomPhoneFeeder.apply(paramName, formatsPath));
    }

    public static Iterator<Map<String, Object>> RandomPSRNSPFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomPSRNSPFeeder.apply(paramName));
    }
    ...
    public static Iterator<Map<String, Object>> RandomRangeStringFeeder(String paramName, Integer from, Integer to, String alphabet) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomRangeStringFeeder.apply(paramName, from, to, alphabet));
    }
    ...
    public static Iterator<Map<String, Object>> RandomRusPassportFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomRusPassportFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomSNILSFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomSNILSFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RandomStringFeeder(String paramName, Integer paramLength) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomStringFeeder.apply(paramName, paramLength));
    }
    ...
    public static Iterator<Map<String, Object>> RandomUUIDFeeder(String paramName) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RandomUUIDFeeder.apply(paramName));
    }

    public static Iterator<Map<String, Object>> RegexFeeder(String paramName, String regex) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.RegexFeeder.apply(paramName, regex));
    }
    ...
    public static final class SeparatedValuesFeeder {
        ...
        public static Iterator<Map<String, Object>> apply(String paramName, String source, char separator) {
            return toJavaFeeder(io.cosmospf.gatling.feeders.SeparatedValuesFeeder.apply(paramName, source, separator));
        }

        public static Iterator<Map<String, Object>> apply(String paramName, List<String> source, char separator) {
            return toJavaFeeder(io.cosmospf.gatling.feeders.SeparatedValuesFeeder.apply(paramName, asScala(source).toSeq(), separator, io.gatling.core.Predef.configuration()));
        }
        ...
        public static Iterator<Map<String, Object>> apply(Optional<String> paramPrefix, List<Map<String, Object>> source, char separator) {
            ...
            return toJavaFeeder(io.cosmospf.gatling.feeders.SeparatedValuesFeeder.apply(_paramPrefix, toScala(source), separator, io.gatling.core.Predef.configuration()));
        }
    ...
    public static Iterator<Map<String, Object>> SequentialFeeder(String paramName, Integer start, Integer step) {
        return toJavaFeeder(io.cosmospf.gatling.feeders.SequentialFeeder.apply(paramName, start, step));
    }
    ...
    public static Iterator<Map<String, Object>> VaultFeeder(
        ...
        return toJavaFeeder(io.cosmospf.gatling.feeders.VaultFeeder.apply(vaultUrl, secretPath, roleId, secretId, asScala(keys).toList()));
    }
}
