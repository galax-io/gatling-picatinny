package io.cosmospf.gatling.config

import scala.concurrent.duration._
import io.cosmospf.gatling.config.ConfigManager.simulationConfig
import io.cosmospf.gatling.utils.IntensityConverter.getIntensityFromString
