...
└── scala-steward.yml                      # EXISTS (weekly cron + dispatch, action@v2) — extend with maintenance-milestone post-step
.scala-steward.conf                        # NEW — update policy
